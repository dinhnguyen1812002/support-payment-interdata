...
export default function AddUserToDepartment({ departmentId, departmentSlug }: Props) {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            setLoading(true);
            try {
                const response = await axios.get(route('users.available', { department: departmentId }));
        ...
        router.post(
            ...
            { user_id: userId },
            {
                onSuccess: () => {
                    ...
                    router.visit(route('departments.employees', { slug: departmentSlug }));
                },
                onError: errors => {
                    toast({
                        title: 'Error',
