            ...
            <div className="mt-5 space-y-4">
                ...
                <div className="flex items-center mb-4 justify-between">
                    <div className="flex items-center space-x-2">
                        ...
                        <div>
                            <p className="text-base font-medium text-gray-800 dark:text-gray-200">{post.user.name}</p>
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        {post.tags.map((tag) => (
                            <Badge
                                key={tag.id}
                                variant="secondary"
                                className="px-3 py-1 text-sm font-medium rounded-lg dark:bg-gray-700 dark:text-blue-400 hover:border-solid"
                            >
                                {tag.name}
                            </Badge>
                        ))}
