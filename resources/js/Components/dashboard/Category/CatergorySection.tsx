...
import { Search, Filter, HelpCircle, Settings, Bug, CreditCard, Shield, Smartphone, Globe, MessageSquare, FileText, Headphones } from 'lucide-react';
...
const CategorySelection: React.FC = () => {
  ...
  const filteredCategories = categories.filter(category => {
    ...
    const matchesPriority = priorityFilter === 'all' || category.priority === priorityFilter;
  ...
  return (
    <div className=" min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 justify-center">
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-gray-600">Select a category to create your support ticket</p>
            </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white shadow-sm"
            >
